...
./build/X86/gem5.opt --debug-flags=PIM configs/example/se.py --cpu-type=TimingSimpleCPU --cpu-clock=2GHz --caches --l2cache --l1d_size=32kB --l1i_size=32kB --l2_size=2MB --l1d_assoc=2 --l1i_assoc=2 --l2_assoc=4 --mem-size=1024MB --coherence-granularity=64B -c ../../PageRank/step2

#./build/X86/gem5.opt --debug-flags=PIM configs/example/se.py --cpu-type=TimingSimpleCPU --cpu-clock=2GHz --caches --l2cache --l1d_size=32kB --l1i_size=32kB --l2_size=2MB --l1d_assoc=2 --l1i_assoc=2 --l2_assoc=4 --enable-pim --pim-type=kernel --kernel-type=pr --num-pim-kernels=1 --mem-size=1024MB --coherence-granularity=64B -c ../../PageRank/step2-PIM
